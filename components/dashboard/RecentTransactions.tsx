  ...
  return (
    <div className="card overflow-hidden">
      <div className="flex items-center justify-between px-5 py-4 border-b border-border">
        <div>
          <h3 className="font-display font-bold text-white text-base">Movimientos recientes</h3>
          <p className="text-white/30 text-xs mt-0.5">Últimas actividades de tu cuenta</p>
        </div>
        <div className="flex items-center gap-2">
          {onRefetch && (
            <button onClick={onRefetch} title="Actualizar"
